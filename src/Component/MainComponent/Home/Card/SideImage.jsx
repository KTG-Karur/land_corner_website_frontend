      ...
      <div className="image-group relative">
        <div className="swiper-container noo carousel-2 img-style swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
          <div
            ...
            id="swiper-wrapper-3d6dd52a8d7e25d6"
            aria-live="polite"
          ...
          <div className="pagi2">
            <div className="swiper-pagination2 swiper-pagination-clickable swiper-pagination-bullets">
              <span
          ...
          <div
            ...
            aria-controls="swiper-wrapper-3d6dd52a8d7e25d6"
            aria-disabled="false"
          >
            <i className="fal fa-arrow-right" />
          </div>
          <div
            className="swiper-button-prev2 swiper-button-disabled"
            tabIndex={-1}
            role="button"
